...
export function setButtonLoadingState(button: HTMLButtonElement, text: string = 'Loading...') {
...
export function clearButtonLoadingState(button: HTMLButtonElement, text: string) {
